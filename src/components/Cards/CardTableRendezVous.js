...
export default function CardTableRendezVous({
  color,
  searchTerm,
  rendezVous,
  onEditRendezVous,
                ...
                >
                  <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                    <div className="flex items-center">
                      ...
                      >
                        {rendezVousItem.patientPrenom}{" "}
                        {rendezVousItem.patientNom}
                      </span>
                    </div>
                  </td>
                  <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                    {new Date(rendezVousItem.date).toLocaleDateString("fr-FR")}{" "}
                  ...
                  <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                    <div className="flex items-center space-x-2">
                      ...
                      {/* Bouton Voir Dossier - NOUVEAU */}
                      <button
                        onClick={() => onViewDossier(rendezVousItem.patientId)}
                        className="bg-purple-500 hover:bg-purple-600 text-white px-3 py-1 rounded text-xs transition-colors duration-200 flex items-center"
